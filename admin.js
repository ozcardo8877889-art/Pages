...
async function uploadImageToSupabase(file) {
    ...
    try {
        if (!supabase) {
            throw new Error('Supabase no está conectado. Verifica tu conexión a internet.');
        }
        ...
        showToast('success', 'Imagen subida', 'La imagen se guardó en Supabase Storage');
        ...
        showToast('error', 'Error al subir imagen', error.message || 'No se pudo subir la imagen');
...
function initProductForm() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const producto = {
            ...
            imagen: formData.get('imagen') || 'imagen1.jpg',
